...
I’m a web designer and front-end developer with a passion for creating intuitive, visually engaging, accessible, and performant digital experiences that drive results. With a background in digital media and design, I bring a unique blend of creativity and technical skill to every project. Bridging the gap between design and development. My approach is rooted in thoughtful design and code, with a deep understanding of how users interact with modern web applications.

I’ve worked across a range of environments, from individual projects to large-scale corporate initiatives, collaborating closely with cross-functional teams to build responsive, user-centered interfaces and design systems. 

I hold an MFA in Emergent Media from Champlain College and a background in digital media and graphic design. Whether I’m designing interfaces or developing front-end solutions, I’m focused on delivering work that not only looks great but performs—helping products and features feel seamless, accessible, and impactful.
